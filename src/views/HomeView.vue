<template>
	<v-content>
		...
		<section id="about">
			...
			<v-container class="text-center">
				...
				>
					...
					public disengagement and encourage collaborative action. Lorem ipsum
					dolor sit, amet consectetur adipisicing elit. Quasi explicabo, atque
					libero veniam repellat dignissimos quod rem eaque error cupiditate.
				</v-responsive>
		...
		<section id="blog">
			...
			<v-container>
				<h2
					class="text-h4 text-sm-h3 font-weight-bold mb-3 text-center text-uppercase"
				>
