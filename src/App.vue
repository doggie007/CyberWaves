<template>
  <v-app>
    ...
    <v-app-bar app color="white" height="100">
      ...
      <v-toolbar-title class="font-weight-black"> CYBERWAVES </v-toolbar-title>
      <v-spacer></v-spacer>
      ...
      <section id="hero">
        <v-row no-gutters>
          <v-img
            ...
            gradient="to top right, rgba(0,0,0,0.1), rgba(0,0,0,.4)"
          >
      ...
      <section id="about">
        ...
        <v-container class="text-center">
          ...
          >
            ...
            voluptatem! Obcaecati, alias ducimus in ipsa pariatur sed, nulla,
            rerum ea omnis eaque sequi? Exercitationem optio distinctio
            corrupti? Molestias provident maiores labore qui aperiam facilis
            consequatur earum rerum exercitationem praesentium, omnis fugiat
            dolore quod tenetur. Aliquam eius maiores tempora provident,
            accusantium ex, expedita iure dignissimos asperiores, quo temporibus
            hic fuga illo.
          </v-responsive>
...
export default {
  ...
  data() {
    return {
      drawer: false,
      links: ["Dashboard", "Messages", "Profile"],
      articles: [
        {
